  ...
  return (
    ...
    >
      ...
      <div className="px-6 pb-6 pt-4">
        ...
        <div className="mt-2 flex items-center gap-2 text-sm text-[#646464]">
          <Star
            size={14}
        ...
        <div className="mt-3 flex items-center gap-2 text-xs text-[#858585]">
          <MapPin size={13} />
          <span>0.4 mi away • Open until 6 PM</span>
        </div>

        <div className="mt-6 flex gap-3">
          <button className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[#007A1F] px-3 py-2.5 text-xs font-semibold text-white transition hover:bg-[#006619]">
            <Phone size={14} />
            Call
          </button>

          <button className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-[#CDD5CE] bg-white px-3 py-2.5 text-xs font-semibold text-[#141414] transition hover:border-[#007A1F] hover:text-[#007A1F]">
