...
const EMPTY_FORM = {
  ...
  // auto-fill every input will, so if it's non-empty we silently drop
  // the submission instead of telling the bot it was caught.
  company_website: "",
};
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <p className="mt-6 font-body text-base leading-relaxed text-[#646464]">
              ...
              {CONTACT_ITEMS.map(({ icon: Icon, label, value }) => (
                <li key={label} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-body text-sm text-[#141414]">{value}</p>
                  </div>
                </li>
              ))}
            </ul>

            <div className="mt-10 overflow-hidden rounded-2xl border border-[#E1E5E1]">
              <iframe
          ...
          <form
            ...
            noValidate
            className="space-y-5 rounded-3xl border border-[#E1E5E1] bg-[#F3FBF4] p-8 lg:col-span-6 lg:col-start-7 lg:p-10"
          >
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
              <div>
                <label htmlFor="contact-name" className="font-mono text-[11px] uppercase tracking-wider text-[#646464]">
                  Name
                </label>
                <input
                  id="contact-name"
              ...
              <div>
                <label htmlFor="contact-subject" className="font-mono text-[11px] uppercase tracking-wider text-[#646464]">
                  Subject
                </label>
                <input
                  id="contact-subject"
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
              <div>
                <label htmlFor="contact-email" className="font-mono text-[11px] uppercase tracking-wider text-[#646464]">
                  Email
                </label>
                <input
                  id="contact-email"
              ...
              <div>
                <label htmlFor="contact-phone" className="font-mono text-[11px] uppercase tracking-wider text-[#646464]">
                  Phone <span className="normal-case text-[#858585]">(optional)</span>
                </label>
                <input
                  id="contact-phone"
                  type="tel"
            ...
            <div>
              <label htmlFor="contact-message" className="font-mono text-[11px] uppercase tracking-wider text-[#646464]">
                Message
              </label>
              <textarea
                id="contact-message"
            ...
            <label className="flex items-start gap-3 font-body text-xs text-[#646464]">
              <input
                type="checkbox"
